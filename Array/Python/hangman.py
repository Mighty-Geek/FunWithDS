...
def selectWord():
  words_to_guess = ["fantasia","godzilla","kingkong","castaway","loveless","tideland","serenity","clueless","deadpool","maverick","firewall","fearless","stardust"]
  myword= random.choice(words_to_guess)
  return myword
